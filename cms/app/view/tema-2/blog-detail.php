                    ...
                    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#comments" role="tab"
                               aria-controls="comments" aria-selected="true">Yorumlar</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="comments" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <?php else: ?>
                                <div id="no-comment">
                                    ...
                                    <p class="card-text">Bu konu için hiç yorum yazılmamış, ilk yorumu siz yazabilirsiniz.
                                    </p>
                        ...
                        <div class="tab-pane fade" id="share" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="share mb-4">
                                ...
                                <a target="_blank"
                                   href="https://twitter.com/home?status=<?= $row['post_title'] ?> - <?= site_url('blog/' . $row['post_url']) ?>"
                                   class="twitter" data-toggle="tooltip" data-placement="top" title="Tweet at">
                                    <span class="fab fa-twitter"></span>
                                </a>
                                <a target="_blank"
                                   href="https://plus.google.com/share?url=<?= site_url('blog/' . $row['post_url']) ?>"
                                   class="gplus" data-toggle="tooltip" data-placement="top" title="Google+'da Paylaş">
                                    <span class="fab fa-google-plus-g"></span>
                                </a>
                                <a target="_blank"
                                   href="https://www.linkedin.com/shareArticle?mini=true&url=<?= site_url('blog/' . $row['post_url']) ?>&title=<?= $row['post_title'] ?>&summary=<?= cut_text($row['post_short_content'], 100) ?>&source="
                                   class="linkedin" data-toggle="tooltip" data-placement="top"
                                   title="Linkedin'de Paylaş">
                                    <span class="fab fa-linkedin-in"></span>
                                </a>
                                <a target="_blank"
                                   href="https://api.whatsapp.com/send?phone=&text=<?= $row['post_title'] ?> - <?= site_url('blog/' . $row['post_url']) ?>&source=&data="
